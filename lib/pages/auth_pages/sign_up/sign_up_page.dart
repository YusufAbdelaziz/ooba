                            ...
                            children: [
                              CustomAuthHeader(
                                title: AppLocalizations.of(context)
                                    .translate('SignUp.createYouAccount'),
                                subTitle:
                                    AppLocalizations.of(context).translate('SignUp.joinCommunity'),
                              ),
                              space(height: 20),
                              BlocBuilder<EmailUsernameValidationBloc,
                                  EmailUsernameValidationState>(builder: (context, state) {
                              ...
                              BlocBuilder<PasswordVisibilityCubit, PasswordVisibilityState>(
                                builder: (context, state) {
                                  ...
                                  return BlocBuilder<PasswordValidationBloc,
                                      PasswordValidationState>(builder: (context, state) {
