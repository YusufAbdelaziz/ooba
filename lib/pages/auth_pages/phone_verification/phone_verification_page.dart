  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: BlocProvider<TimerBloc>(
        create: (_) =>
            TimerBloc(ticker: Ticker(), duration: Duration(seconds: 10,).inSeconds)..add(Start()),
        child: Builder(
          builder: (context) => Scaffold(
            ...
            appBar: CustomAppBar(
              title: AppLocalizations.of(context)
                  ...
                  .toUpperCase(),
              backAction: () => BlocProvider.of<AuthCubit>(context).signUpSwitched(),
            ),
            body: Padding(
                            ...
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context)
                                    .translate('PhoneVerification.subHeader'),
